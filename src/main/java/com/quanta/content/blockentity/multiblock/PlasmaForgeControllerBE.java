...
public class PlasmaForgeControllerBE extends QuantaEnergyBE {

    public PlasmaForgeControllerBE(BlockPos pos, BlockState state) {
        super(ModBlockEntities.PLASMA_FORGE_CONTROLLER.get(), pos, state, QuantumTier.SINGULAR, 2000000);
    }

    @Override
    protected int getBaseEnergyCost() { return 200; }
