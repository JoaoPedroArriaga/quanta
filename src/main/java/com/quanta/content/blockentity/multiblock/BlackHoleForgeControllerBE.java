...
public class BlackHoleForgeControllerBE extends QuantaEnergyBE {

    public BlackHoleForgeControllerBE(BlockPos pos, BlockState state) {
        super(ModBlockEntities.BLACK_HOLE_FORGE_CONTROLLER.get(), pos, state, QuantumTier.SUPERPOSED, 500000);
    }

    @Override
    protected int getBaseEnergyCost() { return 1000; }
