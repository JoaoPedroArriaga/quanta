...
public class QuantumEvaporatorBE extends QuantaEnergyBE {

    public QuantumEvaporatorBE(BlockPos pos, BlockState state) {
        super(ModBlockEntities.QUANTUM_EVAPORATOR.get(), pos, state, QuantumTier.DECOHERENT);
    }
