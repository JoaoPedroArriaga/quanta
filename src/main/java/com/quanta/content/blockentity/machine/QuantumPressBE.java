...
public class QuantumPressBE extends QuantaProcessingBE {

    private static final int INVENTORY_SLOTS = 2;
    private static final int BASE_MAX_PROGRESS = 80;

    public QuantumPressBE(BlockPos pos, BlockState state) {
        super(ModBlockEntities.QUANTUM_PRESS.get(), pos, state,
