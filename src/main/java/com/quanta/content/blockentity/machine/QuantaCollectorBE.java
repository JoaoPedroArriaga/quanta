...
public class QuantaCollectorBE extends QuantaEnergyBE {

    public QuantaCollectorBE(BlockPos pos, BlockState state) {
        super(ModBlockEntities.QUANTA_COLLECTOR.get(), pos, state, QuantumTier.DECOHERENT);
    }
