...
public class QuantumWireDrawerBE extends QuantaProcessingBE {

    private static final int INVENTORY_SLOTS = 2;
    private static final int BASE_MAX_PROGRESS = 60;

    public QuantumWireDrawerBE(BlockPos pos, BlockState state) {
        super(ModBlockEntities.QUANTUM_WIRE_DRAWER.get(), pos, state,
