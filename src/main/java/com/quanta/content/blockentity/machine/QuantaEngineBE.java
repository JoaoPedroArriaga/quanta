...
public class QuantaEngineBE extends QuantaEnergyBE {

    public QuantaEngineBE(BlockPos pos, BlockState state) {
        super(ModBlockEntities.QUANTA_ENGINE.get(), pos, state, QuantumTier.ENTANGLED);
    }
