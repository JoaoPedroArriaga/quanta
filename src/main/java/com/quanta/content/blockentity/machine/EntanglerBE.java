...
public class EntanglerBE extends QuantaEnergyBE {

    public EntanglerBE(BlockPos pos, BlockState state) {
        super(ModBlockEntities.ENTANGLER.get(), pos, state, QuantumTier.ENTANGLED);
    }

    @Override
    protected int getBaseEnergyCost() { return 40; }
