...
public class VoidGeneratorBE extends QuantaEnergyBE {

    public VoidGeneratorBE(BlockPos pos, BlockState state) {
        super(ModBlockEntities.VOID_GENERATOR.get(), pos, state, QuantumTier.SUPERPOSED);
    }

    public void tickServer() {
        if (level == null || level.isClientSide) return;
        energy.addQuanta(500);
        setChangedAndSync();
    }
