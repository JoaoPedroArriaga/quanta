...
public class QuantumCondenserBE extends QuantaEnergyBE {

    public QuantumCondenserBE(BlockPos pos, BlockState state) {
        super(ModBlockEntities.QUANTUM_CONDENSER.get(), pos, state, QuantumTier.DECOHERENT);
    }
