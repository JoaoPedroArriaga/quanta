...
public class QuantumMainframeBE extends QuantaBlockEntity {

    public QuantumMainframeBE(BlockPos pos, BlockState state) {
        super(ModBlockEntities.QUANTUM_MAINFRAME.get(), pos, state);
    }
