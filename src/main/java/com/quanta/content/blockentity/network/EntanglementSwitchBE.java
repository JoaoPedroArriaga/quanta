...
public class EntanglementSwitchBE extends QuantaBlockEntity {

    public EntanglementSwitchBE(BlockPos pos, BlockState state) {
        super(ModBlockEntities.ENTANGLEMENT_SWITCH.get(), pos, state);
    }
