...
public class QuantumTankBE extends QuantaBlockEntity {

    public QuantumTankBE(BlockPos pos, BlockState state) {
        super(ModBlockEntities.QUANTUM_TANK.get(), pos, state);
    }
