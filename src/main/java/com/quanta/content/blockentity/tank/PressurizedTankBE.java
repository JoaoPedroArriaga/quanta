...
public class PressurizedTankBE extends QuantaBlockEntity {

    public PressurizedTankBE(BlockPos pos, BlockState state) {
        super(ModBlockEntities.PRESSURIZED_TANK.get(), pos, state);
    }
