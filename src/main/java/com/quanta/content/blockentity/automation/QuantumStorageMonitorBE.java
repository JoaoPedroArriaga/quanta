...
public class QuantumStorageMonitorBE extends QuantaBlockEntity {

    public QuantumStorageMonitorBE(BlockPos pos, BlockState state) {
        super(ModBlockEntities.QUANTUM_STORAGE_MONITOR.get(), pos, state);
    }
