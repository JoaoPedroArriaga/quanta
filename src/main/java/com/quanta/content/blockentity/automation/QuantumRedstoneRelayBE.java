...
public class QuantumRedstoneRelayBE extends QuantaBlockEntity {

    public QuantumRedstoneRelayBE(BlockPos pos, BlockState state) {
        super(ModBlockEntities.QUANTUM_REDSTONE_RELAY.get(), pos, state);
    }
