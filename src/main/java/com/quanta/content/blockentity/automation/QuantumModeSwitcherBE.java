...
public class QuantumModeSwitcherBE extends QuantaBlockEntity {

    public QuantumModeSwitcherBE(BlockPos pos, BlockState state) {
        super(ModBlockEntities.QUANTUM_MODE_SWITCHER.get(), pos, state);
    }
