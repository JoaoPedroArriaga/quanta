...
public abstract class OrderGasFluid extends BaseFlowingFluid {

    public OrderGasFluid(Properties properties) { super(properties); }

    public static class Source extends OrderGasFluid {
        public Source(Supplier<FluidType> fluidType) {
            super(new Properties(fluidType, ModFluids.ORDER_GAS, ModFluids.ORDER_GAS_FLOWING).block(null).bucket(null));
        }
    ...
    public static class Flowing extends OrderGasFluid {
        public Flowing(Supplier<FluidType> fluidType) {
            super(new Properties(fluidType, ModFluids.ORDER_GAS_FLOWING, ModFluids.ORDER_GAS).block(null).bucket(null));
        }
