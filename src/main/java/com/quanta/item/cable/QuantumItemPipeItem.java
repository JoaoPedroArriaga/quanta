...
public class QuantumItemPipeItem extends BlockItem {
    
    private static final CableType TYPE = CableType.ITEM;

    public QuantumItemPipeItem(Block block, Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("tooltip.quanta.pipe.item"));
