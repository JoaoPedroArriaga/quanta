...
public class QuantumPressurizedPipeItem extends BlockItem {
    
    private static final CableType TYPE = CableType.GAS;

    public QuantumPressurizedPipeItem(Block block, Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("tooltip.quanta.pipe.gas"));
