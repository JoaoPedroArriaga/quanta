...
public class QuantaCableItem extends BlockItem {
    
    private static final CableType TYPE = CableType.ENERGY;

    public QuantaCableItem(Block block, Properties properties) {
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        // ===== CASO 1: Clicou em um CABO existente =====
        ...
        // ===== CASO 2: Clicou na lateral de algum bloco =====
        BlockPos placePos = clickedPos.relative(face);
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("tooltip.quanta.cable.energy"));
        tooltip.add(Component.translatable("tooltip.quanta.cable.energy.desc", TYPE.maxTransfer));
