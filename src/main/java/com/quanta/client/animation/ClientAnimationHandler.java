package com.quanta.client.animation;
...
public class ClientAnimationHandler {
    ...
    public static float getOrbitAngle() { return orbitAngle; }
    public static float getFloatOffset() { return floatOffset; }
    ...
    public static void clear() { animatedBlocks.clear(); }
}